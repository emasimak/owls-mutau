...
definitions = {
    ...
    'weight_mu': (
        ...
        'lep_0_NOMINAL_HLT_mu20_iloose_L1MU15_OR_HLT_mu50_MU_TRIG_QUAL_MEDIUM_MU_TRIG_ISO_GRADIENT'
    ),
    'weight_mu_noiso': (
        'lep_0_NOMINAL_effSF_RecoMedium * '
        'lep_0_NOMINAL_HLT_mu20_iloose_L1MU15_OR_HLT_mu50_MU_TRIG_QUAL_MEDIUM_MU_TRIG_ISO_GRADIENT'
...
_vary_me('mu_tau',
         ...
         '[weight]',
         '#mu+#tau',
         {'mc': expr('[weight_mc] * [weight_pileup] * [weight_mu] * [weight_b] * [weight_tau_medium]')},
         {'rqcd': 'mu_tau_qcd_cr'},
         _variations)
